...
def main():
    ...
    bid_search.click()
    bid_search.send_keys('Writing and Display Board')
    ...
    filtered_df.to_csv(os.path.join(os.getcwd(),'csv_files','bid_data_Writing_and_Display_Board.csv'))
...
if __name__ == '__main__':
    schedule.every().day.at('10:49').do(job)
